      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            ...
            <a href="<?php echo e(url('checkout')); ?>" class="text-black-300 hover:bg-gray-300 hover:text-black px-3 py-2 rounded-md text-sm font-medium">Checkout</a>

            <a href="<?php echo e(url('promo')); ?>" class="text-black-300 hover:bg-gray-300 hover:text-black px-3 py-2 rounded-md text-sm font-medium">Promo</a>

            
            <a href="<?php echo e(url('profile')); ?>" class="text-black-300 hover:bg-gray-300 hover:text-black px-3 py-2 rounded-md text-sm font-medium">Profile</a>
...
<div class=" font-sans pt-8 text-center">
 ...
 </div><?php /**PATH E:\SEMESTER 3\TEKNO.WEB\kecak\resources\views/frontpage/landingpage.blade.php ENDPATH**/ ?>