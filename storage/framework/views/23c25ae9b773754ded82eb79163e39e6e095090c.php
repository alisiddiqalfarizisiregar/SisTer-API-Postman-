...
<button type="button" class="inline-block mx-4 px-6 py-2 border2 border-blue-600 text-blue-600 font-medium text-xs leading-tight uppercase rounded-rmd hover:bg-indigo-100 hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration150 ease-in-out">Check</button>
 ...
 <img src="https://telegra.ph/file/8f22b0e09528466eb04bd.jpg" alt="" class="h-48 w-full md:h-full md:w-56 inset-0 wfull object-cover rounded-lg" loading="lazy" />
 </div>
<form class="p-6">
...
<div class="flex space-x-4 mb-5 text-sm font-medium">
 ...
 <a href="/pesantiket">Book now</a><button class="h-10 px-6 font-semibold rounded-full bg-violet-600 text-white" type="submit">
</button>
...
<div class="md:flex font-sans pt-8">
 <div class="md:shrink-0">
 <img src="https://telegra.ph/file/8b7b1f3d79669600d2df8.jpg" alt="" class="h-48 w-full md:h-full md:w-56 inset-0 wfull object-cover rounded-lg" loading="lazy" />
 </div>
<form class="p-6">
 <div class="flex flex-wrap">
 <h1 class="flex-auto font-medium text-slate-900">
...
<div class="flex space-x-4 mb-5 text-sm font-medium">
 <div class="flex-auto flex space-x-4">
 <a href="/pesantiket">Book now</a><button></button>
 <button data-bs-toggle="modal" data-bstarget="#exampleModalLg" class="h-10 px-6 font-semibold rounded-full border border-slate200 text-slate-900" type="button">
 Check Availability
</button>
 </div>
...
<div class=" font-sans pt-8 text-center">
 ...
 </div><?php /**PATH D:\semester 3\teknologi web\kecak_men\resources\views/frontpage/landingpage.blade.php ENDPATH**/ ?>