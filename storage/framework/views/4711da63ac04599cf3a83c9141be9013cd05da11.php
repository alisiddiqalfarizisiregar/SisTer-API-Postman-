                    ...
                    <div class="flex justify-around md:justify-around py-5">
                        <div class="grid md:grid-cols-3 grid-cols-1 gap-6">
                            ...
                            <div class="font-sans pt-8 border-slate-200">
                                <div class="max-w-sm">
                                    <div class="">
                                        <img src="https://cf.shopee.co.id/file/4c2082b0909c6db4478303ec96bcd3c4"
                            ...
                            <div class="font-sans pt-8 border-slate-200">
                                <div class="max-w-sm">
                                    <div class="md:shrink-0">
                                        <img src="https://image.jimcdn.com/app/cms/image/transf/dimension=470x1024:format=jpg/path/s2b27b14ae2b3149c/image/ia552215b2b382cd9/version/1394142003/image.jpg"
                                            alt="" class="md:h-80 md:w-56 inset-0 object-cover rounded-lg"
                                            loading="lazy" />
                                    </div>
                                    <form class="pt-6">
                        ...
                        <div class="relative ">
                            ...
                            <div class="flex justify-between mt-5 mb-5">
                                <span class="font-sans text-sm ">Chana limbata</span>
                            ...
                            <div class="flex justify-between mb-5 text-slate-400">
                                <span class="font-sans text-sm ">biaya pakan</span>
...
</div><?php /**PATH D:\semester 3\teknologi web\kecak\resources\views/frontpage/pemesananikan.blade.php ENDPATH**/ ?>