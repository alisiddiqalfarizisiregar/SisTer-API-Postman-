...
<div class="md:flex font-sans pt-8">
    ...
    <img src="https://cf.shopee.co.id/file/4c2082b0909c6db4478303ec96bcd3c4" alt="" class="h-48 w-full md:h-full md:w-56 inset-0 wfull object-cover rounded-lg" loading="lazy" />
    </div>
   <form class="p-6">
   ...
   <div class="flex space-x-4 mb-5 text-sm font-medium">
    ...
    <a href="/pesanikan" style="border-left-color: black">Book now</a>
   ...
   <p>comunity : <?php echo e($item->comunity->comunity_name); ?></p>
   <p class="text-sm text-slate-500">
    lengkap dengan bahan pakan makanan
    </p>
    </form>
    </div>
...
<div class=" font-sans pt-8 text-center">
 ...
 </div><?php /**PATH D:\semester 3\teknologi web\kecak\resources\views/frontpage/landingpage.blade.php ENDPATH**/ ?>